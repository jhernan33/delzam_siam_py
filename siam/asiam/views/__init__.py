...
# from .articulo        import ArticuloListView, ArticuloCreateView, ArticuloRetrieveView, ArticuloUpdateView, ArticuloDestroyView
...
# from .tretenciones    import TretencionesListView, TretencionesCreateView, TretencionesRetrieveView, TretencionesUpdateView, TretencionesDestroyView
# from .waletr          import WaletrListView, WaletrCreateView, WaletrRetrieveView, WaletrUpdateView, WaletrDestroyView

#from .menu import MenuListView, MenuCreateView, MenuRetrieveView, MenuUpdateView, MenuDestroyView
#from .menu_f import Menu_fListView, Menu_fCreateView, Menu_fRetrieveView, Menu_fUpdateView, Menu_fDestroyView

#from .operador import OperadorListView, OperadorCreateView, OperadorRetrieveView, OperadorUpdateView, OperadorDestroyView
#from .operador_c import Operador_cListView, Operador_cCreateView, Operador_cRetrieveView, Operador_cUpdateView, Operador_cDestroyView
#from .operador_f import Operador_fListView, Operador_fCreateView, Operador_fRetrieveView, Operador_fUpdateView, Operador_fDestroyView
#from .organizacion import OrganizacionListView, OrganizacionCreateView, OrganizacionRetrieveView, OrganizacionUpdateView, OrganizacionDestroyView
