...
from .clienteView       import ClienteListView, ClienteCreateView, ClienteRetrieveView, ClienteUpdateView, ClienteDestroyView, ClienteReportView, ClienteExportFile, ClienteComboView, ClienteBuscarView, HistoryCustomer, exportHistoryCustomer, ClienteStatus
from .userView          import SignupView, LoginView, LogoutView, UserView, ResetPasswordView
...
from .articuloView     import ArticuloListView, ArticuloCreateView, ArticuloRetrieveView, ArticuloUpdateView, ArticuloDestroyView, ArticuloComboView, ImportDataArticle, ArticleFilter, ArticuloSearch
...
from .pedidoView import PedidoListView, PedidoCreateView, PedidoRetrieveView, PedidoUpdateView, PedidoDestroyView, PedidoComboView, PedidoHistorico, PedidoHistoricoUpdateView, PedidoUpdateStatusView, PedidoReport, PedidoSearchView
