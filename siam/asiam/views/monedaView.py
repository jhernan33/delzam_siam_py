...
class MonedaCreateView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            result_description = MonedaSerializer.validate_desc_esta(request.data['description'],False,None)
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                # Validate Description
                result_description = MonedaSerializer.validate_desc_esta(request.data['description'],state_deleted,instance.id)
